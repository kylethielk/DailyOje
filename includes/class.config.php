...
//    private $productionServers = array('/^your-domain\.com$/');
    private $productionServers = array('/^www.sample.com$/');
    private $stagingServers = array();
    private $localServers = array('/^127.0.0.1$/', '/^localhost$/');
    ...
    private $twitterConsumerKey = 'change-me';//As provided by twitter
    private $twitterConsumerSecret = 'change-me';//As provided by twitter

	
    private $jQueryUrl = '';//The full URL to jquery
    private $googleFontUrl = '';//The full URL to FONT file
    private $dailyOjeJsUrl = '';//The full url to the daily oje JS file
    ...
    private function production()
    {
        ...
        $this->dbName = 'dailyoje';
        $this->dbReadUsername = 'change-me';
        $this->dbWriteUsername = 'change-me';
        $this->dbReadPassword = 'change-me';
        $this->dbWritePassword = 'change-me';
        $this->dbOnError = '';
        $this->dbEmailOnError = false;

        $this->googleFontUrl = '//fonts.googleapis.com/css?family=Source+Sans+Pro:400,700,400italic';
        $this->jQueryUrl = '//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js';
        $this->dailyOjeJsUrl = root_url() . 'dailyoje.min.js';
    }
    ...
    private function local()
    {
        ...
        $this->googleFontUrl = 'css/googlefont.css';
        $this->jQueryUrl = 'thirdjs/jquery.min.js';
        $this->dailyOjeJsUrl = 'dailyoje.full.js';
    }
