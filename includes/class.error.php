...
class Error
{
    static $TWITTER_CURRENT_URL_NOT_SET = array('code' => 10101, 'message' => "There was an error with your request. Please try again.");
    static $TWITTER_START_OAUTH_UNKNOWN = array('code' => 10102, 'message' => "There was an error with your request. Please try again.");
    static $TWITTER_FINALIZE_ERROR = array('code' => 10103, 'message' => "There was an error finalizing your twitter login. Please try again.");
    static $TWITTER_INVALID_REDIRECT_URL = array('code' => 10104, 'message' => 'There was an error with your request. Please try again.');

    static $NOTE_AUTOSAVE_NO_ID = array('code' => 10105, 'message' => 'There was an error with the autosave. If the problem persists please contact us.');
    static $NOTE_AUTOSAVE_NO_TEXT = array('code' => 10106, 'message' => 'There was an error with the autosave. If the problem persists please contact us.');
    static $NOTE_AUTOSAVE_NO_TITLE = array('code' => 10107, 'message' => 'There was an error with the autosave. If the problem persists please contact us.');
    static $NOTE_AUTOSAVE_INVALID_NID = array('code' => 10108, 'message' => 'There was an error with the autosave. If the problem persists please contact us.');
    static $NOTE_AUTOSAVE_INVALID_USER = array('code' => 10109, 'message' => 'There was an error with the autosave. If the problem persists please contact us.');
    static $NOTE_FETCH_NOT_LOGGED_IN = array('code' => 10110, 'message' => 'Could not fetch notes. If the problem persists please contact us.');

    static $NOTE_UPDATE_PRIVACY_NO_ID = array('code' => 10111, 'message' => 'There was an error updating note privacy. If the problem persists please contact us.');
    static $NOTE_UPDATE_PRIVACY_NO_VALUE = array('code' => 10112, 'message' => 'There was an error updating note privacy. If the problem persists please contact us.');
    static $NOTE_UPDATE_PRIVACY_INVALID_VALUE = array('code' => 10113, 'message' => 'There was an error updating note privacy. If the problem persists please contact us.');
    static $NOTE_UPDATE_PRIVACY_INVALID_USER = array('code' => 10114, 'message' => 'There was an error updating note privacy. If the problem persists please contact us.');

    static $NOTE_LOAD_NOTE_NO_ID = array('code' => 10115, 'message' => 'There was an error loading your note. If the problem persists please contact us.');
    static $NOTE_LOAD_NOTE_INVALID_USER = array('code' => 10116, 'message' => 'You do not have access to this note. If the problem persists please contact us.');

    static $NOTE_VIEW_NO_ID = array('code' => 10117, 'message' => 'You did not provide a note to view.');
    static $NOTE_VIEW_INVALID_ID = array('code' => 10118, 'message' => 'This note does not exist.');

    static $NOTE_DELETE_NOTE_NO_ID = array('code' => 10119, 'message' => 'There was an error deleting your note. If the problem persists please contact us.');
    static $NOTE_DELETE_NOTE_INVALID_USER = array('code' => 10120, 'message' => 'You do not have access to this note. If the problem persists please contact us.');
    static $NOTE_DELETE_NOTE_DB = array('code' => 10121, 'message' => 'There was an error deleting your note. If the problem persists please contact us.');


    static $GENERIC_NOT_LOGGED_IN = array('code' => 10201, 'message' => 'You must be logged in to perform that action.');
    ...
    public function add($errorObject)
    {
        $id = $errorObject['code'];
    ...
    public function errorTimed($timeout)
    {
        if (count($this->errors) == 0)
        {
            return '';
        ...
        $out = '';
        foreach ($this->errors as $error)
            $out = $out . '<script type="text/javascript">OJE.showMessage(\'' . implode(' ', $error) . '\',' . $timeout . ');</script>';
